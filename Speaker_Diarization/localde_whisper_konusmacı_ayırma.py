...
# --- 2. OpenAI Whisper ile sesi yazıya çevir ---
try:
    model = whisper.load_model("base")  # Daha iyi modeller: "small", "medium", "large"
    result = model.transcribe("gecici_ses.wav", language="tr")
    metin = result["text"]
    print("Yazıya Çevrilen Metin:\n")
    print(metin)
except Exception as e:
    print(f"Whisper ile metne çevirme hatası: {e}")
