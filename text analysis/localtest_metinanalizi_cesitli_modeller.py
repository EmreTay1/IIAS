...
# İndirdiğiniz GGUF model dosyasının adını doğrulayın.Model listesi:
#gemma-3-1b-it-openr1-turkish
#turkish-llama-8b-instruct-v0.1
#sambanovasystems_-_sambalingo-turkish-chath
#google/gemma-3n-e4b ve google/gemma-3-12b--yavas
#thinking-camel-7b
MODEL_NAME = "thinking-camel-7b"
...
OUTPUT_DOCX_FILE = "analiz_sonucu_thinking-camel-7b.docx"
